...
import meet1 from "../assets/image/meet-img1.png";
import meet2 from "../assets/image/meet-img2.png";
import meet3 from "../assets/image/meet-img3.png";

const Meet = () => {
  return (
    <div className="max-w-[1140px] mx-auto px-3 ">
      <h2 className="text-[33px] md:text-[64px] font-normal leading-[108%] text-white font-azo text-center pt-5 md:pt-[110px]">
        Meet The Team
      </h2>
      ...
      <div className="flex flex-wrap">
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          <h2 className="text-2xl font-bold leading-[108%] font-Montserrat text-white ">
            Jaylon Schleifer
          </h2>
          <p className="text-xl font-normal leading-[108%] font-Montserrat text-white pt-3">
            Carter Septimus
          </p>
          <div className=" rounded-[20px] border-[3px] border-[#FDDA60] w-[230px] h-[230px] mt-8 shadow-[0_0_15px_0_#FDDA60] overflow-hidden">
            <img className=" rounded-[20px] hover:scale-[1.1] duration-300" src={meet1} alt="meet" />
          </div>
        </div>
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          <p className="text-2xl font-semibold text-white font-Montserrat leading-[108%]">
            @Jaylon Schleifer
          </p>
          <p className="text-xl font-normal leading-[108%] font-Montserrat text-white pt-3">
            Nearly two decades in Business
          </p>
          <p className="text-bace font-normal font-Montserrat text-white leading-[160%] pt-8">
            Faucibus risus id libero interdum in nisl nibh risus molestie.
            Gravida purus mauris nulla duis est eleifend. Suspendisse eu iaculis
            odio sit. Hac orci massa habitasse congue nulla tristique.{" "}
          </p>
          <p className="text-bace font-normal font-Montserrat text-white leading-[160%] pt-2">
            {" "}
      ...
      <div className="flex flex-wrap ">
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          ...
          <div className=" rounded-[20px] border-[3px] border-[#FDDA60] w-[230px] h-[230px] mt-8 shadow-[0_0_15px_0_#FDDA60] overflow-hidden">
            <img className=" rounded-[20px] hover:scale-[1.1] duration-300" src={meet2} alt="meet" />
          </div>
        </div>
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          <p className="text-2xl font-semibold text-white font-Montserrat leading-[108%]">
          ...
          <p className="text-bace font-normal font-Montserrat text-white leading-[160%] pt-8">
            Neque hendrerit lectus neque molestie facilisis. Faucibus arcu eget
            facilisis nisl id ultricies. Aliquet eget scelerisque posuere
      ...
      <div className="flex flex-wrap">
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          ...
          <div className=" rounded-[20px] border-[3px] border-[#FDDA60] w-[230px] h-[230px] mt-8 shadow-[0_0_15px_0_#FDDA60] overflow-hidden">
            <img className=" rounded-[20px] hover:scale-[1.1] duration-300" src={meet3} alt="meet" />
          </div>
        </div>
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          <p className="text-2xl font-semibold text-white font-Montserrat leading-[108%]">
