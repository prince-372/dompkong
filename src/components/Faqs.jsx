...
import footerimg from '../assets/image/footer-img.png';     
function Accordion({ question, answer }) {
    ...
    return (
        <div className="bg-black bg-faqs relative">
            <h2 className="text-white text-[64px] font-azo font-normal text-center pb-9 mt-5 ">FAQs</h2>
            ...
            <div className="flex justify-center items-center gap-5 mb-7">
                <span><a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D" target="_blank" className=" hover:animate-bounce">
                ...
                <span>
                    <a href="https://discord.com/channels/@me/1118136067724423238" target="_blank" className=" animate-bounce">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span>
                    <a href="https://telegram.org/" target="_blank" className=" hover:animate-bounce">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-[247px] h-[247px] bg-[#FDDA60] blur-[146.5px] absolute left-0 bottom-0 hidden md:block"></div>
