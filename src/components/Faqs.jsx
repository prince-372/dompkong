    ...
    return (
        <div className="bg-black bg-faqs relative">
            ...
            <div className="flex justify-center items-center gap-5 mb-7">
                <span><a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D" target="_blank" className=" animate-bounce">
                ...
                <span>
                    <a href="https://telegram.org/" target="_blank" className=" animate-bounce">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
